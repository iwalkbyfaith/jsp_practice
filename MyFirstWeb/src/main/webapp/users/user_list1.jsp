...
<%
	...
	// ★★★ (이전 파일들과 다른 변경점) 이제부터 java.sql 관련 변수들도 앞으로 위에서 미리 선언을 한다.★★★
		Connection con =null;
